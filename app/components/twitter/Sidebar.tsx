...
import TwitterSender from "./ContentSenderBox";
import PublishMessage from "./Z-PublishMessage";
import { ConnectButton } from "@rainbow-me/rainbowkit";
import NewMessage from "./Z-GetMessage";
import Verify from "./Z-Verify";
...
const Sidebar: FC = () => {
  ...
  const [showPMessage, setShowPMessage] = useState(false);
  const [showMessage, setShowMessage] = useState(false);
  const [signVerify, setSignVerify] = useState(false);
  const [message, setMessage] = useState(false);
  const [PlaintextString, setPlaintextString] = useState("");
  const [isMessageProcessing, setIsMessageProcessing] = useState<CryptoKey[]>([]);

  return (
    <>
      <AppContext.Provider value={{ message, setMessage, isMessageProcessing, setIsMessageProcessing,PlaintextString,setPlaintextString}}>
      <div className={cx(s.left, s.sidebar)}>
        <div className={s.logo}>
          <svg viewBox="0 0 24 24" aria-hidden="true" className={s.svg}>
            <g>
              <path
        ...
        <div className={s.links}>
          ...
          <div className={s.item}>
            ...
            <span className={s.title}>Explore</span>
          </div>
          <div className={s.item}>
            <svg viewBox="0 0 24 24" aria-hidden="true" className={s.svg}>
              <g>
          ...
          <div className={s.item}>
            ...
            <span className={s.title}>Bookmarks</span>
          </div>
          <div className={s.item}>
            <svg viewBox="0 0 24 24" aria-hidden="true" className={s.svg}>
              <g>
            ...
            <span className={s.title}>Twitter Blue</span>
          </div>
          <div className={s.item}>
            <svg viewBox="0 0 24 24" aria-hidden="true" className={s.svg}>
              <g>
        ...
        <div className={s.actions}>
          <div className={s.action_button} onClick={() => setShowMask(true)}>
            Tweet
          </div>
          <div
        ...
        <div className={s.user}>
          <div className={s.user_wrap}>
            ...
            <div className={s.info}>
              <span className={s.username} style={{ display: 'block' }}>HaochengWang </span>
              <span className={s.user_id} style={{ display: 'block' }}>@ChirsWong12</span>
            </div>
            <div className={s.menu}>
              <svg viewBox="0 0 24 20" aria-hidden="true" className={s.svg}>
                <g>
                  <path
      ...
      <div
        className={s.fullscreen_mask}
        style={{ display: showMask ? "block" : "none" }}
      >
        <div className={s.sender_container}>
        ...
        {/* {showPMessage && (
          <div className={s.fullscreen_mask}>
            <div className={s.sender_container}>
              <div className={s.header}>
                <MdClose
                  className={s.close_icon}
                  onClick={() => setShowPMessage(false)}
                />
              </div>
              <PublishMessage />
            </div>
        ...
        <div style={{ display: showPMessage ? "block" : "none" }}>
          <div className={s.fullscreen_mask}>
            <div className={s.sender_container}>
              <div className={s.header}>
                <MdClose
        ...
        {/* {showMessage && (
          <div className={s.fullscreen_mask} style={{}}>
            <div className={s.sender_container}>
              <div className={s.header}>
                <MdClose
                  className={s.close_icon}
          ...
          <div className={s.fullscreen_mask} style={{}}>
            <div className={s.sender_container}>
              <div className={s.header}>
                <MdClose
                  className={s.close_icon}
                  onClick={() => setSignVerify(false)}
                />
              </div>
              <Verify open={showMessage} />
            </div>
          </div>
        )} */}

        <div style={{ display: signVerify ? "block" : "none" }}>
          <div className={s.fullscreen_mask} style={{}}>
            <div className={s.sender_container}>
              <div className={s.header}>
                <MdClose
