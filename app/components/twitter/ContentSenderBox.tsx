...
const TwitterSender = ({
  ...
  return (
    <div className={s.twitter_sender}>
      <div className={s.sender_left}>
        <Image
          className={s.avatar}
          src="/tokisakiyuu.png"
          alt="tokisakiyuu"
      ...
      <div className={s.sender_right}>
        ...
        <div className={s.rbottom}>
          ...
          <div className={s.sender_button_group}>
            <div className={s.sender_button}>Tweet</div>
            <div
              className={s.more_menu}
            ...
            >
              ...
              >
                <div className={s.item} onClick={onPublishMessage}>
                  Schedule
                </div>
                <div className={s.item}>Save draft</div>
              </div>
            </div>
          </div>
        </div>
